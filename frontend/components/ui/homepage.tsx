...
export default function Homepage() {
  return (
  <div className="min-h-screen bg-gradient-to-br from-[#fff8e1] to-[#f5e8c7] font-sans text-[#2d1a00]">
    
          {/* Modern Header with Glass Effect - Fixed */}
      <header className="w-full bg-white/90 backdrop-blur-md py-6 px-8 flex items-center justify-between fixed top-0 z-50 shadow-md border-b border-[#bfa76a]/20">
        <div className="flex items-center gap-4">
          <img src="/goldpe-logo.svg" alt="GoldPe Logo" className="h-12 w-12 hover:scale-110 transition-transform duration-300" />
          <span className="text-3xl font-extrabold bg-gradient-to-r from-[#bfa76a] to-[#2d1a00] bg-clip-text text-transparent tracking-wide">GoldPe</span>
        </div>
        <div className="flex items-center gap-8">
          <nav className="hidden md:flex gap-8 text-lg font-semibold text-[#2d1a00]/80">
            <a href="#lease" className="hover:text-[#bfa76a] transition-colors duration-300">Lease</a>
            <a href="#partner" className="hover:text-[#bfa76a] transition-colors duration-300">Partner</a>
            <a href="#about" className="hover:text-[#bfa76a] transition-colors duration-300">About</a>
          </nav>
          <div className="flex gap-4">
            <a href="/login" className="px-6 py-3 rounded-xl border-2 border-[#bfa76a] text-[#2d1a00] font-medium hover:bg-[#bfa76a] hover:text-white transition-all duration-300">Login</a>
            <a href="/signup" className="px-6 py-3 rounded-xl bg-[#009688] text-white font-medium shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">Sign Up</a>
          </div>
        </div>
      </header>

    {/* Live Rates Section */}
      <section className="w-full bg-gradient-to-r from-[#bfa76a] to-[#009688] py-8 px-6 mt-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="text-center lg:text-left">
            <h3 className="text-2xl font-bold text-white mb-2">Live Market Rates</h3>
            <p className="text-white/80 text-sm">Updated every 15 seconds</p>
          </div>
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            <div className="bg-white/20 backdrop-blur-md rounded-xl px-6 py-4 text-center">
              <span className="text-white/80 text-sm">Gold (24K)</span>
              <div className="text-3xl font-bold text-white">₹7,250/g</div>
            </div>
            <div className="bg-white/20 backdrop-blur-md rounded-xl px-6 py-4 text-center">
              <span className="text-white/80 text-sm">Silver</span>
              <div className="text-3xl font-bold text-white">₹92/g</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto max-w-7xl px-6 pt-16 pb-20 flex flex-col md:flex-row items-center justify-between gap-14">
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <a href="#buy" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gradient-to-r from-[#009688] to-[#009688] text-white font-bold shadow-md hover:shadow-lg transition-all duration-300">
              Get Started
        ...
        <div className="flex-1 flex justify-center">
            <div className="bg-white rounded-3xl shadow-2xl border border-[#bfa76a]/30 p-10 w-full max-w-md relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-white to-[#f5e8c7]/40 pointer-events-none"></div>
                <div className="absolute inset-0 rounded-3xl border-2 border-white/60 pointer-events-none" style={{boxShadow: '0 8px 32px 0 rgba(191,167,106,0.10)'}}></div>
                <div className="relative z-10">
                    <div className="flex justify-between items-center mb-8">
                        <span className="text-xl font-bold text-[#009688]">Buy Digital Gold</span>
                        <span className="text-sm font-medium text-white bg-gradient-to-r from-[#009688] to-[#bfa76a] px-3 py-1 rounded-full shadow">Live Price</span>
                    </div>
                    ...
                    <div className="space-y-5 mb-8">
                        <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow border border-[#bfa76a]/10">
                            <span className="text-sm font-medium text-gray-700">Buy Amount</span>
                            <input type="number" placeholder="₹ 1,000" className="bg-transparent text-right text-lg font-semibold text-[#bfa76a] w-24 outline-none" />
                        </div>
                        <div className="text-xs text-center text-gray-600">
                            <span className="text-[#bfa76a] font-semibold">0.138g</span> of gold for ₹1,000
                        </div>
                    </div>
                    <button className="w-full py-3 rounded-xl bg-gradient-to-r from-[#009688] to-[#bfa76a] text-white font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5">
                        Buy Now → ₹1,000
                    </button>
    ...
    <section className="container mx-auto max-w-7xl flex flex-col md:flex-row items-stretch justify-center py-24 px-8 gap-12">
      <div className="flex-1 flex flex-col justify-center items-start py-16 px-12 bg-white text-[#2d1a00] rounded-3xl shadow-2xl border border-[#009688]/30 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-white to-white"></div>
        <div className="absolute inset-0 rounded-3xl border-2 border-white/40 pointer-events-none" ></div>
        <div className="relative z-10">
      ...
      <div className="flex-1 flex flex-col justify-center items-start py-16 px-12 bg-white text-[#2d1a00] rounded-3xl shadow-2xl border border-[#bfa76a]/30 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-white to-white"></div>
        ...
        <ul className="text-lg space-y-4 mb-8">
          {[
            ...
            <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gradient-to-r from-[#009688] to-[#009688] flex items-center justify-center">
        ...
        <a href="#solutions" className="group inline-flex items-center gap-2 px-8 py-3 rounded-full border-2 border-[#009688] text-[#009688] font-bold bg-white shadow-lg hover:bg-[#009688] hover:text-white transition-all duration-300">
          Explore Solutions
          <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          </svg>
      ...
      <section className="container mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-[#bfa76a]/10">
            <div className="w-16 h-16 bg-gradient-to-br from-[#009688] to-[#009688] rounded-xl flex items-center justify-center mb-6 mx-auto">
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    ...
    <div className="text-center mt-16">
      <a href="#buy" className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-[#009688] to-[#009688] text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
