    ...
    <DataTable
      ...
      structure={[
...

        {
          ...
          header: t("Method"),
          cell: ({ row }) => (
            <span className="line-clamp-2 w-[100px] text-sm font-normal capitalize text-foreground">
              {row.original.method}
            </span>
          ),
        },
          ...
          cell: ({ row }) => (
            <div className="flex items-center gap-1">
              <Button
                ...
                asChild
              >
                <Link href={`/deposits/${row.original?.id}`} prefetch={false}>
                  <Eye />
                </Link>
              </Button>
            </div>
