...
CREATE TABLE `transactions` (
  ...
  `from` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '{}' CHECK (json_valid(`from`)),
  `to` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '{}' CHECK (json_valid(`to`)),
  `amount` double NOT NULL,
  `fee` double NOT NULL,
